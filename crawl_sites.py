...
def crawl_from_1688(url):
    ...
    # driver = webdriver.Chrome(executable_path='/opt/ansible/ansible/chromedriver', options=chrome_options)
    ...
    price = driver.find_elements(By.XPATH, "//span[@class='price-text']")
    start = driver.find_element(By.XPATH, "//span[@class='unit-text']").text
